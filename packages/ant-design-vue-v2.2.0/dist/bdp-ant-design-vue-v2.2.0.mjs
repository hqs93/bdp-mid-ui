...
import { defineComponent as E$, useSlots as T$, ref as x$, reactive as C$, toRefs as so, watch as et, toRaw as Fe, nextTick as I$, resolveComponent as ci, openBlock as wn, createElementBlock as vi, unref as er, renderSlot as nt, createCommentVNode as ru, createBlock as co, isRef as R$, withCtx as An, createVNode as vo, mergeProps as N$, createSlots as M$, Fragment as W$, createTextVNode as ho, toDisplayString as hi, createElementVNode as L$, defineAsyncComponent as F$ } from "vue";
...
(function(t, u) {
  (function() {
    ...
    nr[Mi] = nr[Wi] = nr[Li] = nr[Fi] = nr[Pi] = nr[Ui] = nr[Bi] = nr[bi] = nr[Gi] = !0, nr[un] = nr[mt] = nr[Bn] = nr[Mn] = nr[fn] = nr[Wn] = nr[yt] = nr[St] = nr[kr] = nr[Ln] = nr[ve] = nr[Fn] = nr[Xr] = nr[Pn] = nr[Un] = !1;
    var rr = {};
    ...
    var _p = function d(S) {
      ...
      function Zn(r, e, n, a) {
        ...
        if (!g)
          return $;
        n && (e = tr(e, Nr(n))), a ? (c = Vi, p = !1) : e.length >= o && (c = bn, p = !1, e = new Je(e));
        r:
          for (; ++l < g; ) {
      ...
      function ga(r, e, n) {
        for (var a = n ? Vi : Et, l = r[0].length, c = r.length, p = c, g = m(c), $ = 1 / 0, w = []; p--; ) {
          var A = r[p];
          p && e && (A = tr(A, Nr(e))), $ = mr(A.length, $), g[p] = !n && (e || l >= 120 && A.length >= 120) ? new Je(p && A) : i;
        }
        A = r[0];
        var O = -1, T = g[0];
        r:
      ...
      function Og(r) {
        return fr(r) && li(r.length) && !!nr[Sr(r)];
      }
      function bf(r) {
      ...
      function ma(r, e, n, a) {
        ...
        for (r === e && (e = Dr(e)), n && (g = tr(r, Nr(n))); ++c < p; )
      ...
      function xa(r) {
        return de(function(e) {
          return e = tr(e, Nr(M())), G(function(n) {
            var a = this;
...
`);
      ...
      function Ll(r, e) {
        if (!(r && r.length))
          return [];
        var n = ba(r);
        return e == null ? n : tr(n, function(a) {
          return Rr(e, i, a);
        });
      }
      ...
      var X_ = Fg(function(r, e) {
        e = e.length == 1 && U(e[0]) ? tr(e[0], Nr(M())) : tr($r(e, 1), Nr(M()));
        var n = e.length;
        return G(function(a) {
...
`) + O + `return __p
      ...
      var Vd = xa(tr), Qd = xa(cf), jd = xa(ji);
      function lo(r) {
      ...
      function f$(r) {
        return U(r) ? tr(r, fe) : Wr(r) ? [r] : Dr(xl(k(r)));
      }
      function l$(r) {
        var e = ++mp;
        return k(r) + e;
...
const rW = { class: "basic-tree" }, eW = { key: 0 }, nW = { style: { color: "#f50" } }, tW = { key: 1 }, uW = /* @__PURE__ */ E$({
  ...
  setup(t, { expose: u, emit: i }) {
    ...
    return et(() => f.dataSource, (W) => {
      ...
      return wn(), vi("div", rW, [
        er(o).search ? nt(W.$slots, "search", { key: 0 }) : ru("", !0),
        er(o).search ? ru("", !0) : (wn(), co(cr, {
          key: 1,
          placeholder: "\u8BF7\u8F93\u5165\u5173\u952E\u5B57",
          value: er(y),
        ...
        vo(lr, {
          ...
          default: An(() => [
            er(_).length ? (wn(), co(Ir, N$({
              key: 0,
              class: "tree-operation-class"
            }, W.$attrs, {
              treeData: er(_),
              "field-names": er(D),
              "default-expand-all": er(x),
              "auto-expand-parent": er(E),
              onExpand: Z,
              onSelect: ir,
              selectedKeys: er(v).selectedKeys,
              "onUpdate:selectedKeys": N[1] || (N[1] = (vr) => er(v).selectedKeys = vr)
            }), M$({
              title: An((vr) => [
                er(o).row ? nt(W.$slots, "row", {
                  key: 0,
                  node: vr
                }) : (wn(), vi(W$, { key: 1 }, [
                  vr[er(D).title].indexOf(er(y)) > -1 ? (wn(), vi("span", eW, [
                    ho(hi(vr[er(D).title].substr(0, vr[er(D).title].indexOf(er(y)))) + " ", 1),
                    L$("span", nW, hi(er(y)), 1),
                    ho(" " + hi(vr[er(D).title].substr(vr[er(D).title].indexOf(er(y)) + er(y).length)), 1)
                  ])) : (wn(), vi("span", tW, hi(vr[er(D).title]), 1))
                ], 64))
              ]),
              _: 2
            }, [
...
const fW = F$(() => import("./tree.a7617541.mjs"));
export {
  fW as AsyncBdpTree,
  uW as BdpTree,
  pu as TreeUtils
